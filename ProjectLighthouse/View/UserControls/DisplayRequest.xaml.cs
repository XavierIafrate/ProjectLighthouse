...
namespace ProjectLighthouse.View.UserControls
{
    public partial class DisplayRequest : UserControl
    {
        ...
        private static void SetValues(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (requestControl.Request.TotalQuantity >= 1200)
            {
            ...
            else if (requestControl.Request.TotalQuantity >= 500)
            {
                ...
                b = (Brush)Application.Current.Resources["Orange"];
            }
            else
            {
            ...
            requestControl.RatingImage.Data = g;
            requestControl.RatingImage.Fill = b;
            ...
            {
                requestControl.statusBadge.Background = (Brush)Application.Current.Resources["RedFaded"];
                requestControl.statusText.Foreground = (Brush)Application.Current.Resources["Red"];
            }
            else if (requestControl.Request.Status == Request.RequestStatus.Draft)
            {
                requestControl.statusBadge.Background = (Brush)Application.Current.Resources["PurpleFaded"];
                requestControl.statusText.Foreground = (Brush)Application.Current.Resources["Purple"];
            }
            else
            {
                requestControl.statusBadge.Background = (Brush)Application.Current.Resources["BlueFaded"];
                requestControl.statusText.Foreground = (Brush)Application.Current.Resources["Blue"];
            }
        }
